...
class Ant(Insect):
    ...
    def double(self):
        ...
        # BEGIN Problem 12
        "*** YOUR CODE HERE ***"
        if hasattr(self, 'damage') and not self.have_doubled:
            self.damage *= 2
        ...
        if self.chew_countdown > 0:
            ...
            if self.place and self.place.bees:
                ...
                if bee is not None:
                    ...
                    self.chew_countdown = self.eating_time   
# END Problem 7
        ...
        while place is not None:
            ...
            if ant is not None:
                if ant.is_container and ant.ant_contained is not None:
                    if hasattr(ant.ant_contained, 'double'):
                        ant.ant_contained.double()
                if hasattr(ant, 'double'):
                    ant.double()
            place = place.exit
        # END Problem 12
